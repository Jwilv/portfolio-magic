...
export const Presentation = () => {
    return (
        <div className='flex flex-col justify-center h-screen w-screen relative'>
            ...
            <h1 className='2xl:text-9xl lg:text-8xl font-bold md:w-[890px] md:ml-[180px] lg:bg-[#E8E7EA] md:text-7xl sm:text-6xl text-5xl ml-10'>Wilvers Juan<br /> Front End Dev.</h1>
            <Image
                src={Scroll}
